    ...
    if (props === 'purchase') {
        return (
            <div className='flex flex-col justify-center items-center min-h-screen bg-base-200'>
                ...
                <h1 className='font-bold'>You have successfully placed the order. Please check the <Link className='text-primary' to='/dashbord/'>My Order Page</Link> to complete the payment</h1>
